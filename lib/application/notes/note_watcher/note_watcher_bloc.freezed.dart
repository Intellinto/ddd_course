...
mixin _$NoteWatcherState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult loadingProgress(),
  ...
  TResult map<TResult extends Object>({
    ...
    @required TResult loadingProgress(_LoadingProgress value),
  ...
  TResult maybeMap<TResult extends Object>({
    ...
    TResult loadingProgress(_LoadingProgress value),
